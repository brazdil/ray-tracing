...
private:
	...
	void compute_pixel(socket_ptr sock, pTask task, pThreadSemaphore thread_semaphore, pResultSender result_sender, unsigned int col, unsigned int row, unsigned int image_width);
	...
	void protocol_event_loop(socket_ptr sock, pTask task, uint32_t image_width, uint32_t image_height);
	...
	void protocol_event_loop_solve_task(socket_ptr sock, pTask task, uint32_t image_width, uint32_t image_height, uint32_t col_from, uint32_t col_to, uint32_t first_row);
